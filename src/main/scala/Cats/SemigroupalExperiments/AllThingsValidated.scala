...
object AllThingsValidated:
  ...
  def validate(m: Map[String, String]): V[SignUp] = {
    ...
    ).mapN(SignUp.apply) // SemigroupalExperiments + Functor under the hood
  }

  @main def runAllThingsValidated(args: String*): Unit =
    println("File /Users/drmark/IdeaProjects/PLANE/src/main/scala/Cats/SemigroupalExperiments/AllThingsValidated.scala created at time 12:43PM")
